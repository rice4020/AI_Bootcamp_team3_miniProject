      ...
      <main style={{ flex: 1, padding: '40px 24px', display: 'flex', justifyContent: 'center' }}>
        <div style={{ width: '100%', maxWidth: '1000px', display: 'flex', flexDirection: 'column', gap: '32px' }}>
          ...
          <div style={{ display: 'grid', gridTemplateColumns: 'repeat(4, 1fr)', gap: '20px' }}>
            ...
            <div className="glass-panel clickable-card" onClick={() => handleCardClick('owners')} style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '8px', cursor: 'pointer' }}>
            ...
            <div className="glass-panel clickable-card" onClick={() => handleCardClick('active_trucks')} style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '8px', borderLeft: '4px solid var(--success)', cursor: 'pointer' }}>
            ...
            <div className="glass-panel clickable-card" onClick={() => handleCardClick('total_trucks')} style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '8px', cursor: 'pointer' }}>
            ...
            <div className="glass-panel clickable-card" onClick={() => handleCardClick('suspended_users')} style={{ padding: '24px', display: 'flex', flexDirection: 'column', gap: '8px', borderLeft: '4px solid var(--danger)', cursor: 'pointer' }}>
                      ...
                      <tr key={row.id} style={{ borderBottom: '1px solid var(--border-light)', color: 'var(--text-main)' }}>
                        {detailType === 'owners' && (
                          <>
                            ...
                            <td style={{ padding: '12px 8px', color: 'var(--text-secondary)' }}>{new Date(row.createdAt).toLocaleDateString()}</td>
                          </>
                        )}
                        {detailType === 'active_trucks' && (
                          <>
